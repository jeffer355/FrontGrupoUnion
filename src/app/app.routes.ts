...
export const routes: Routes = [
    ...
    // --- PANEL ADMINISTRADOR ---
    {
        ...
        children: [
            ...
            // Módulos de Gestión Corporativa
            ...
            // --- NUEVA RUTA PARA CONTRATOS ---
            { path: 'contratos', loadComponent: () => import('./admin-dashboard/components/admin-contratos/admin-contratos.component').then(m => m.AdminContratosComponent) }
        ]
    }
];